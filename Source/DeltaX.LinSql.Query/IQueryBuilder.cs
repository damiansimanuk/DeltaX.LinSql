...
namespace DeltaX.LinSql.Query
{
        ...
        where T2 : class
    {
        ...
        new IQueryBuilder<T1, T2> Limit(int skipCount, int rowsPerPage); 
    }
        ...
        where T3 : class
    {
        ...
        new IQueryBuilder<T1, T2, T3> Limit(int skipCount, int rowsPerPage); 
    }
        ...
        where T4 : class
    {
        ...
        new IQueryBuilder<T1, T2, T3, T4> Limit(int skipCount, int rowsPerPage); 
    }
       ...
       where T5 : class
    {
        ...
        new IQueryBuilder<T1, T2, T3, T4, T5> Limit(int skipCount, int rowsPerPage); 
    }
       ...
       where T6 : class
    {
        ...
        new IQueryBuilder<T1, T2, T3, T4, T5, T6> Select<TEntity>(TEntity entity = null) where TEntity : class;
        IQueryBuilder<T1, T2, T3, T4, T5, T6> Select<P>(Expression<Func<T1, T2, T3, T4, T5, T6, P>> property, string columnAlias);
        ...
        new IQueryBuilder<T1, T2, T3, T4, T5, T6> Limit(int skipCount, int rowsPerPage); 
    }
}
