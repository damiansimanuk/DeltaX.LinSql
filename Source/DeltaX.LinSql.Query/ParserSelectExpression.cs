namespace DeltaX.LinSql.Query
{
    ...
    public class ParserSelectExpression : ExpressionVisitor
    {
        private QueryStream stream;  
        private bool openBrace;

        public ParserSelectExpression(Expression expression, TableQueryFactory tableFactory = null, IEnumerable<Type> allowedTables = null,
        ...
        public ParserSelectExpression(QueryStream stream)
        {
            this.stream = stream; 
        }
